...
\BodeZPK[%
samples=1000,
axes/mag/{ymin=-40,ymax=20, minor x tick num =8, minor y tick num=9},
axes/ph/{ymin=-200,ymax=10, minor x tick num =8, minor y tick num=9},
plot/mag/{red,ultra thick},
plot/ph/{red,ultra thick},
group/{group style={group size=2 by 1,horizontal sep=2cm},width=6cm,height=6cm},
]
{%
z/{},
p/{},
