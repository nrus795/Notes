...
:::::{layout="[[40,-6,60],[40,-5,60]]" fig-pos="H" layout-align="center"}
:::{#first-column-row1}
Let $G(s)=5$
...
\begin{semilogxaxis}[
    ...
    minor x tick num=8,        % 8 minor ticks per decade (log scale)
    minor y tick num = 9,
    grid style={line width=.1pt, draw=gray!50},
    major grid style={thick,draw=gray},
]
    % Draw a horizontal line for the constant gain
    \addplot[domain=1e-2:1e2, samples=2, red, ultra thick] {13.9};
\end{semilogxaxis}
\end{tikzpicture}
```
:::
...
\begin{semilogxaxis}[
    ...
    minor x tick num=8,        % 8 minor ticks per decade (log scale)
    minor y tick num = 9,
    ytick={-200,-150,-100,-50,0,50},
    grid style={line width=.1pt, draw=gray!50},
    major grid style={thick,draw=gray},
]
    % Draw a horizontal line for the constant phase
    \addplot[domain=1e-2:1e2, samples=2, red, ultra thick] {0};
    \addplot[domain=1e-2:1e2, samples=2, red, ultra thick] {-180};
\end{semilogxaxis}
\end{tikzpicture}
```
:::
