...
$$
	K_p = \lim_{s \to 0} G(s) = \lim_{s \to 0} \dfrac{K(s+z_1)(s+z_2) \ldots (s+z_m)}{s^N(s+p_1)(s+p_2) \ldots (s+p_n)} = \textcolor{red}{\infty}, \quad N \geq 1
$$
...
$$
	\textcolor{red}{e_{ss} = \dfrac{1}{K_1}, \quad \text{for Type-0 System}}
$$

$$
	\textcolor{red}{e_{ss} = 0, \quad \text{for Type-1 or higher System}}
$$
...
$$
	\textcolor{red}{r(t) = t, \; \implies \; R(s) = \dfrac{1}{s^2}}
$$
...
$$
	\textcolor{red}{e_{ss} = \dfrac{1}{K_v}=\infty, \quad \text{for Type-0 System}}
$$

$$
	\textcolor{red}{e_{ss} = \dfrac{1}{K_v} = \dfrac{1}{K_1}, \quad \text{for Type-1 System}}
$$

$$
	\textcolor{red}{e_{ss}=0, \quad \text{for Type-2 or higher System}}
$$
...
$$
	\textcolor{red}{r(t) = \dfrac{t^2}{2}, \quad \forall t \geq 0, \quad r(t) = 0, \quad \forall t < 0 \quad \implies \quad R(s) = \dfrac{1}{s^3}}
$$
...
$$
	K_a = \lim_{s \to 0} s^2G(s) = \lim_{s \to 0} \dfrac{s^2K(s+z_1)(s+z_2)\ldots(s+z_m)}{s^N(s+p_1)(s+p_2)\ldots(s+p_n)} = \textcolor{red}{\infty}, \quad N \geq 3
$$

Summary: The steady state error $e_{ss}$, for a unit parabolic input:

$$
	\textcolor{red}{e_{ss} = \dfrac{1}{K_a} = \infty, \quad \text{for Type-0 and Type-1 Systems}}
$$

$$
	\textcolor{red}{e_{ss} = \dfrac{1}{K_a} = \dfrac{1}{K_1}, \quad \text{for Type-2 System}}
$$

$$
	\textcolor{red}{e_{ss} = 0, \quad \text{for Type-3 or higher System}}
$$
...
$$
	\textcolor{red}{K_p = \lim_{s \to 0} G(s), \quad e(\infty) = \dfrac{1}{1+K_p}}
$$

$$
	\textcolor{red}{K_v = \lim_{s \to 0} sG(s), \quad e(\infty) = \dfrac{1}{K_v}}
$$

$$
	\textcolor{red}{K_a = \lim_{s \to 0} s^2G(s), \quad e(\infty) = \dfrac{1}{K_a}}
$$
...
$$
	\textcolor{red}{K_p = \lim_{s \to 0} G(s), \quad e(\infty) = \dfrac{a}{1+K_p}}
$$

$$
	\textcolor{red}{K_v = \lim_{s \to 0} sG(s), \quad e(\infty) = \dfrac{b}{K_v}}
$$

$$
	\textcolor{red}{K_a = \lim_{s \to 0} s^2G(s), \quad e(\infty) = \dfrac{2c}{K_a}}
$$
