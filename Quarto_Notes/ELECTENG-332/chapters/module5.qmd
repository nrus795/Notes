...
2.  The [first row of the Routh Array consists of the **first, third, fifth, ...** coefficients (even values of $n$ in $a_n$)]{color=red}, where the [second row consists of the **second, fourth, sixth, ...** coefficients (odd values of $n$ in $a_n$)]{color=blue}, as shown below.
...
\begin{table}[H]
	...
	\label{tab:routh_array}
	\begin{tblr}{
		width = \linewidth,       % Full width of the page
		rows={ht={0.75\baselineskip}},
		colspec = {*6{X[c]}},  % Dynamic column widths
		cells = {m,c,mode=dmath},              % Centered cells
		vline{2} = {-}{},         % Vertical line after first column for all rows
		hline{1} = {-}{}     % Horizontal lines at specific rows
    }
...
$$
    \textcolor{blue}{b_1 = \dfrac{a_1 a_2 - a_0 a_3}{a_1}, \; b_2 = \dfrac{a_1 a_4 - a_0 a_5}{a_1}, \; b_3 = \dfrac{a_1 a_6 - a_0 a_7}{a_1}, \ldots}
$$

Following a similar procedure, the evaluation of the $c_i$ coefficients are computed as follows:

$$
    \textcolor{blue}{c_1 = \dfrac{b_1 a_3 - a_1 b_2}{b_1}, \; c_2 = \dfrac{b_1 a_5 - a_1 b_3}{b_1}, \; c_3 = \dfrac{b_1 a_7 - a_1 b_4}{b_1}, \ldots}
$$
...
We can define $B$ as:
$$
    B = \left\{ b_i \in \mathbb{R} \; \middle| \; b_i = \dfrac{a_1 a_{2i} - a_0 a_{2i+1}}{a_1}\qcomma i\in \mathbb{N}\qcomma 1 \leq i \leq m \right\}
$$
\end{definition}
...
We can define $C$ as:
$$
    C = \left\{ c_i \in \mathbb{R} \; \middle| \; c_i = \dfrac{b_1 a_{2i+1} - a_1 b_{i+1}}{b_1}\qcomma i\in \mathbb{N}\qcomma 1 \leq i \leq n \right\}
$$
\end{definition}
``` 
