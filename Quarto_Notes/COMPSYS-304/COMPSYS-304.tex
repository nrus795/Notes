...
\phantomsection\label{PerformanceQuestion}
...
\phantomsection\label{CourseDetails}
\section{Course Details}\label{course-details}

\phantomsection\label{LearningOutcomes}
...
\phantomsection\label{CourseOverview}
...
\phantomsection\label{Assessment}
...
\phantomsection\label{02BasicsComputerArch}
This chapter begins the journey into the content of this course.

\phantomsection\label{WhatIsComputerArchitecture}
...
\phantomsection\label{ReviewMemOrg}
...
\phantomsection\label{MemVsCPUSpeed}
...
\phantomsection\label{ProcessorAndMemoryHierarchy}
...
\phantomsection\label{IntelProcessorExample}
