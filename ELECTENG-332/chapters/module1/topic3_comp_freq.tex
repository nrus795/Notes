...
\end{figure}
\vspace{-1em}
\noindent For example, if a signal has a complex frequency  \complexqty[output-complex-root=j, complex-root-position=before-number]{314i}{\radian\per\sec}, then this corresponds to a pure sinusoid of frequency \SI{314}{\radian\per\sec} (i.e. \SI{50}{\hertz}).\\ 
Furthermore:
\begin{figure}[H]
    \centering
    \begin{mdframed}
